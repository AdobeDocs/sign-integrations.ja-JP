...
![画像](images/edit-details-clinical-type.png)
...
1. 開いたAdobe Signログインページで、アカウント管理者の電子メールアドレスとパスワードを入力し、「 **[!UICONTROL ログイン]**&#x200B;を選択します。
...
1. 表示された接続を追加ダイアログで、必要な詳細情報 ( [!DNL Veeva Vault] 資格情報。
   ...
   Adobe Signの資格情報は、最初のAdobe Signログインから自動入力されます。
